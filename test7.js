      ...
      function (require, module, exports) {
        ...
        var l = function (t) {
          ...
          return e.createViewer({
            render(values) {
              return `<div style="color: ${values.textColor}; background-color: ${values.backgroundColor};">I am a custom very cool tool.</div>`;
            },
          });
        };
        unlayer.registerTool({
          ...
          renderer: {
            ...
            head: {
              css: function (e) {},
              js: function (e) {
                console.log("this is tool custom js when dragged and dropped");
              },
            },
          },
        });
